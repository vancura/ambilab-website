 ...
 * performance testing using Lighthouse CI. It measures Core Web Vitals and other
 * performance metrics to ensure the website maintains high performance standards.
 *
 * Note: This file uses CommonJS (.cjs) format because the project uses ES modules
 * by default (package.json has "type": "module"), but Lighthouse CI requires CommonJS.
 *
 * Usage:
 ...
 *   - collect: Data collection settings (URLs, Chrome config, Lighthouse settings)
 *   - upload: Where to upload results (temporary-public-storage or custom server)
 *   - assert: Performance budgets and thresholds that must be met
 *
...
/**
 * @typedef {Object} LighthouseConfig
 * @property {Object} ci - Lighthouse CI configuration
 */
...
module.exports = {
    ci: {
        collect: {
            ...
            /**
             * Lighthouse runtime settings
             * These settings control how Lighthouse simulates the testing environment
             */
            settings: {
                /**
                 ...
                 * Tests how the site performs on a typical desktop screen
                 */
                screenEmulation: {
                    mobile: false,
                    width: 1350,
        ...
        assert: {
            ...
            assertions: {
                ...
                // Performance: Overall performance score (critical for UX)
                'categories:performance': ['error', { minScore: 0.9 }],

                // Accessibility: WCAG compliance and best practices
                'categories:accessibility': ['warn', { minScore: 0.9 }],

                // Best Practices: Security, browser compatibility, and modern standards
                 ...
                 * These provide deeper insights into page performance
                 */
                 ...
                 * Helps catch runtime issues early
                 */
