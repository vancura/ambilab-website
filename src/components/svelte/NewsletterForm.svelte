...
<div class="rounded-lg bg-blue-50 p-6 dark:bg-blue-950">
    ...
    <form onsubmit={handleSubmit} class="flex gap-2">
        <input
            ...
            class="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900"
        />
        <button
            type="submit"
            disabled={status === 'loading'}
